...
try:
    ...
    from agent_resolver.cache import CacheProvider, default_cache
...
class AgentResolver:
    ...
    def resolve(self, uri: Union[str, AgentUri]) -> Tuple[AgentDescriptor, Dict[str, Any]]:
        """
    ...
    def _resolve_via_well_known(self, uri: AgentUri) -> Tuple[AgentDescriptor, Dict[str, Any]]:
        """
        ...
        try:
            ...
            if 'agents' in agents_registry and isinstance(agents_registry['agents'], dict):
