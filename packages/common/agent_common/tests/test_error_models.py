...
class TestErrorModels(unittest.TestCase):
    ...
    def test_agent_problem_detail_creation(self):
        ...
        self.assertEqual(problem_dict["type"], "https://agent-uri.org/errors/capability-not-found")
        self.assertEqual(problem_dict["title"], "Capability Not Found")
        self.assertEqual(problem_dict["status"], 404)
        self.assertEqual(problem_dict["detail"], "The requested capability was not found.")
    ...
    def test_agent_error_creation(self):
        ...
        self.assertEqual(problem.type, "https://agent-uri.org/errors/capability_not_found")
    ...
    def test_problem_from_exception_with_agent_error(self):
        ...
        self.assertEqual(problem.type, "https://agent-uri.org/errors/authentication_failed")
