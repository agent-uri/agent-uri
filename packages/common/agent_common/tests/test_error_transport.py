...
from agent_common.error.models import AgentProblemDetail, ErrorCategory, create_problem_detail
...
class TestErrorTransport(unittest.TestCase):
    ...
    def test_format_for_http(self):
        ...
        self.assertEqual(body["type"], "https://agent-uri.org/errors/capability-not-found")
        ...
        headers, status, body = format_for_http(
            self.problem, {"X-Request-ID": "12345"}
        )
        self.assertEqual(headers["Content-Type"], "application/problem+json")
    ...
    def test_format_for_websocket(self):
        ...
        error = message["error"]
        self.assertEqual(error["type"], "https://agent-uri.org/errors/capability-not-found")
    ...
    def test_parse_http_error_with_problem_json(self):
        ...
        self.assertEqual(problem.type, "https://agent-uri.org/errors/capability-not-found")
