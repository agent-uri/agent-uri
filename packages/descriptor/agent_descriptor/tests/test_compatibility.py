...
def test_is_agent_card_compatible():
    ...
    compatible = AgentDescriptor(
        ...
        capabilities=[
            Capability(name="compatible-capability")
        ],
        skills=[
            Skill(id="compatible-skill", name="Compatible Skill")
        ]
    )
    ...
    incompatible = AgentDescriptor(
        ...
        version="1.0.0",
        capabilities=[
            Capability(name="incompatible-capability")
        ],
    ...
    incompatible2 = AgentDescriptor(
        ...
        skills=[
            Skill(id="incompatible-skill", name="Incompatible Skill")
        ]
    )
...
def test_to_format():
    ...
    descriptor = AgentDescriptor(
        ...
        version="1.0.0",
        capabilities=[
            Capability(name="format-capability")
        ],
        skills=[
            Skill(id="format-skill", name="Format Skill")
        ],
...
def test_is_format_compatible():
    ...
    descriptor = AgentDescriptor(
        ...
        version="1.0.0",
        capabilities=[
            Capability(name="compatibility-capability")
        ],
        skills=[
            Skill(id="compatibility-skill", name="Compatibility Skill")
        ]
    )
...
def test_converter_classes():
    ...
    descriptor = AgentDescriptor(
        ...
        version="1.0.0",
        capabilities=[
            Capability(name="converter-capability")
        ],
        skills=[
            Skill(id="converter-skill", name="Converter Skill")
        ]
    )
