...
from typing import Dict, Any, List, Optional, Protocol, Type, cast
...
class Agent2AgentConverter:
    ...
    def to_external(descriptor: AgentDescriptor) -> Dict[str, Any]:
        ...
        if descriptor.provider:
            agent_card["provider"] = {
                "organization": descriptor.provider.organization
            }
        ...
        if descriptor.authentication:
            ...
            if descriptor.authentication.details and "credentials" in descriptor.authentication.details:
                agent_card["authentication"]["credentials"] = descriptor.authentication.details["credentials"]
...
class JsonLdConverter:
    ...
    def to_external(descriptor: AgentDescriptor) -> Dict[str, Any]:
        ...
        from agent_descriptor.parser import descriptor_to_dict
        jsonld_dict = descriptor_to_dict(descriptor)
        
        # Add JSON-LD specific fields
        jsonld_dict["@context"] = descriptor.context or "https://example.org/agent-context.jsonld"
    ...
    def from_external(jsonld_data: Dict[str, Any]) -> AgentDescriptor:
        ...
        from agent_descriptor.parser import parse_descriptor
